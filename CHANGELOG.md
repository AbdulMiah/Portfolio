...
- Special thanks to [@oliverphardman](https://github.com/oliverphardman), for finding and fixing the Date in the Experience section displaying NaN error for Firefox or other browsers using the SpiderMonkey JS engine.
